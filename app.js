...
var incompleteTaskHolder=document.querySelector(".to-do-list_incomplete");//ul of #completed-tasks
...
var createNewTaskElement=function(taskString){
  ...
  //button.button_edit
  var editButton=document.createElement("button");//button_edit

  //button.button_delete
  var deleteButton=document.createElement("button");//button_delete 
  var deleteButtonImg=document.createElement("img");//delete image
  ...
  //and appending.
  listItem.className = 'to-do-list__item task'
...
var editTask=function(){
  ...
  //If class of the parent is .to-do-list__item_edit-mode
  if(containsClass){

  //switch to .to-do-list__item_edit-mode
  ...
  //toggle .to-do-list__item_edit-mode on the parent.
...
//select ListItems children
  ...
  //Bind deleteTask to button_delete.
